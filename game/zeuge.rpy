...
label zeuge:
    ...
    menu:
        you "Ich bin nicht religiös. Der Tag ist aber trotzdem schön.":
            zeuge: "Aber jeder Tag wird doch durch Religion schöner!"
        you "Ja, preiset den mächtigen Erlöser! Er und seine Erdbeeren werden uns befreien!":
            "Sie rümpft die Nase, fasst sich dann aber schnell wieder."zeuge: "Erdbeerianismus ist von gestern."
        you "Bleib mir bloß mit Religion weg":
            zeuge: "Gerade Leute wie Sie könnten Religion gut gebrauchen!"
    zeuge "Möchten Sie nicht von meiner Religion hören?"
    menu:
        you "Nein, danke!":
            "Sie ignoriert dich und fährt unbeirrt fort." $not_strawberry = True
        you "Ja warum nicht!":
            "Ihre Augen leuchten auf und sie beginnt begeistert zu reden"$not_strawberry = True
        you "Beleidige nicht mich und mein unbändiges Vertrauen in die Erdbeeren, Versucherin!":
            "Sie spuckt auf der Stelle aus." $not_strawberry = False
    if not_strawberry:
        "Also, ich bin von den Whiskasianeren und wir glauben, dass die Katzen uns irgendwann erretten werden!"
        menu:
            you "Ist das nicht so ein komischer Furry-Sex-Kult?":
                "Nein, das ist nur Nebensache. Der Sex ist trotzdem gut!" 
                menu:
                    you "Na gut ich komme mit, wo kann ich mich anmelden?":
                        zeuge "Kommen Sie doch mit in den Tempel, ich zeige Ihnen da {i}ALLES{\i}"
                    you "Nein, danke kein Interesse":
                        "Sie schaut enttäuscht und sagt den Rest der Fahrt beleidigt kein Wort mehr"

            you "Das klingt interessant. Ich mag Katzen, wo kann ich mich anmelden?":
                "Ihre Augen leuchten und lächelnd antwortet sie:" zeuge: "Kommen Sie doch mit in den Tempel"
            you  "Bloß nicht! Da geh ich ja lieber zum Kult der Großen AI!":
                "Sie schaut enttäuscht und sagt den Rest der Fahrt beleidigt kein Wort mehr"
